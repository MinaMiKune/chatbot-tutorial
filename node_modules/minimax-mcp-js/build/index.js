...
import { DEFAULT_TRANSPORT_MODE, TRANSPORT_MODE_REST, TRANSPORT_MODE_SSE, TRANSPORT_MODE_STDIO, } from './const/index.js';
export async function startMiniMaxMCP(customConfig) {
    try {
...
function isCLIEntry() {
    ...
    if (invokedName === selfName)
        return true; // node build/index.js
    if (invokedName === 'minimax-mcp-js')
        return true; // global bin
    return false;
}
if (isCLIEntry()) {
