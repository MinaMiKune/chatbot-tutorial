...
export class VideoAPI {
    ...
    async generateVideo(request) {
        ...
        try {
            ...
            const response = await this.api.post('/v1/video_generation', requestData);
            // Get task ID
            ...
            for (let attempt = 0; attempt < maxRetries; attempt++) {
                // Query task status
                const statusResponse = await this.api.get(`/v1/query/video_generation?task_id=${taskId}`);
            ...
            const fileResponse = await this.api.get(`/v1/files/retrieve?file_id=${fileId}`);
    ...
    async queryVideoGeneration(request) {
