...
import { DEFAULT_SERVER_ENDPOINT, DEFAULT_SERVER_PORT, TRANSPORT_MODE_REST, OUTPUT_DIRECTORY_DESCRIPTION, } from './const/index.js';
import { McpServer } from '@modelcontextprotocol/sdk/server/mcp.js';
import { ListPromptsRequestSchema, GetPromptRequestSchema, ListToolsRequestSchema, CallToolRequestSchema, ListResourcesRequestSchema, ReadResourceRequestSchema } from '@modelcontextprotocol/sdk/types.js';
...
export class MCPRestServer {
    ...
    extractApiKeyFromRequest(request) {
        ...
        if (metaAuth?.api_key)
            return metaAuth.api_key;
        if (metaAuth?.apiKey)
            return metaAuth.apiKey;
        // API key not found
        return undefined;
    }
    /**
     ...
     */
    async handleTextToAudio(args, api, mediaService, attempt = 1) {
        try {
     ...
     */
    async handleListVoices(args, api, mediaService, attempt = 1) {
        try {
            // Call media service to handle request
     ...
     */
    async handleTextToImage(args, api, mediaService, attempt = 1) {
        try {
            // Call media service to handle request
     ...
     */
    async handleGenerateVideo(args, api, mediaService, attempt = 1) {
        try {
            // Call media service to handle request
     ...
     */
    async handleVoiceClone(args, api, mediaService, attempt = 1) {
        try {
            // Call media service to handle request
     ...
     */
    async handleImageToVideo(args, api, mediaService, attempt = 1) {
        try {
     ...
     */
    async handleVideoGenerationQuery(args, api, mediaService, attempt = 1) {
        try {
            // Call media service to handle request
     ...
     */
    async handleGenerateMusic(args, api, mediaService, attempt = 1) {
        try {
            // Call media service to handle request
     ...
     */
    async handleVoiceDesign(args, api, mediaService, attempt = 1) {
        try {
            // Call media service to handle request
