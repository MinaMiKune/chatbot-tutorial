...
import { MinimaxAuthError, MinimaxRequestError } from '../exceptions/index.js';
        ...
        try {
            ...
            if (baseResp && baseResp.status_code !== 0) {
                ...
                if (baseResp.status_code === 1004) {
                    throw new MinimaxAuthError(`API Error: ${baseResp.status_msg}, Please check your API key and API host. ` +
            ...
            if (axios.isAxiosError(error)) {
                ...
                if (axiosError.response) {
                    throw new MinimaxRequestError(`Request failed (${axiosError.response.status}): ${axiosError.response.statusText}. ` +
                        `Response content: ${JSON.stringify(axiosError.response.data)}`);
                }
                else if (axiosError.request) {
                    throw new MinimaxRequestError(`Request sent but no response received, possibly a network issue: ${axiosError.message}`);
                }
                else {
