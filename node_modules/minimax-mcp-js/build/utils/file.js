 ...
 */
export function buildOutputPath(dir) {
 ...
 */
export function buildOutputFile(filename, dir, ext, useRandomSuffix) {
 ...
 * @returns Complete file path
 */
export function processInputFile(filePath) {
 ...
 */
export function generateTimestampFilename(prefix, ext) {
