...
import { DEFAULT_SERVER_ENDPOINT, DEFAULT_SERVER_PORT, ERROR_API_KEY_REQUIRED, ERROR_API_HOST_REQUIRED, RESOURCE_MODE_URL, TRANSPORT_MODE_SSE, DEFAULT_VOICE_ID, DEFAULT_SPEECH_MODEL, DEFAULT_SPEED, DEFAULT_VOLUME, DEFAULT_PITCH, DEFAULT_EMOTION, DEFAULT_FORMAT, DEFAULT_SAMPLE_RATE, DEFAULT_BITRATE, DEFAULT_CHANNEL, DEFAULT_LANGUAGE_BOOST, DEFAULT_T2I_MODEL, DEFAULT_VIDEO_MODEL } from './const/index.js';
...
export class MCPSSEServer {
    ...
    registerTextToAudioTool() {
        this.mcpServer.tool('text_to_audio', 'Convert text to audio with a given voice and save the output audio file to a given directory. If no directory is provided, the file will be saved to desktop. If no voice ID is provided, the default voice will be used.\n\nNote: This tool calls MiniMax API and may incur costs. Use only when explicitly requested by the user.', {
    ...
    registerListVoicesTool() {
        this.mcpServer.tool('list_voices', 'List all available voices. Only supported when api_host is https://api.minimax.chat.', {
            voiceType: z
                .string()
                .optional()
                .default('all')
    ...
    registerPlayAudioTool() {
        this.mcpServer.tool('play_audio', 'Play an audio file. Supports WAV and MP3 formats. Does not support video.', {
    ...
    registerVoiceCloneTool() {
        this.mcpServer.tool('voice_clone', 'Clone a voice using the provided audio file. New voices will incur costs when first used.\n\nNote: This tool calls MiniMax API and may incur costs. Use only when explicitly requested by the user.', {
    ...
    registerTextToImageTool() {
        this.mcpServer.tool('text_to_image', 'Generate images based on text prompts.\n\nNote: This tool calls MiniMax API and may incur costs. Use only when explicitly requested by the user.', {
    ...
    registerGenerateVideoTool() {
        this.mcpServer.tool('generate_video', 'Generate a video based on text prompts.\n\nNote: This tool calls MiniMax API and may incur costs. Use only when explicitly requested by the user.', {
            model: z
                .string()
                .optional()
    ...
    registerImageToVideoTool() {
        this.mcpServer.tool('image_to_video', 'Generate a video based on an image.\n\nNote: This tool calls MiniMax API and may incur costs. Use only when explicitly requested by the user.', {
            model: z
                .string()
                .optional()
                .default('I2V-01')
    ...
    registerQueryVideoGenerationTool() {
        this.mcpServer.tool('query_video_generation', 'Query the status of a video generation task.', {
            taskId: z
                .string()
    ...
    registerMusicGenerationTool() {
        this.mcpServer.tool('music_generation', 'Create a music generation task using AI models. Generate music from prompt and lyrics.\n\nNote: This tool calls MiniMax API and may incur costs. Use only when explicitly requested by the user.', {
            prompt: z
                .string()
    ...
    registerVoiceDesignTool() {
        this.mcpServer.tool('voice_design', 'Generate a voice based on description prompts.\n\nNote: This tool calls MiniMax API and may incur costs. Use only when explicitly requested by the user.', {
            prompt: z
                .string()
     ...
     */
    async handleClientMessage(transport, req, res, attempt = 1) {
        try {
